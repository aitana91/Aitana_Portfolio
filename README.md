...
In this case the recommendation is based on the movies that the user has watched. We will use the cosine similarity to find the most similar users and we will recommend the user the most watched movies among these similar users.
